...
const PENLIGHT = {
  ...
  members: [
    ...
    { name: "倉野尾成美", nickname: "なる", group: "Team8", colors: ["赤", "緑"], source: "official2022" },
    { name: "坂川陽香", nickname: "ひゆか", group: "Team8", colors: ["赤", "オレンジ"], source: "official2022" },
    { name: "下尾みう", nickname: "みう", group: "Team8", colors: ["白", "紫"], source: "official2022" },
    { name: "髙橋彩音", nickname: "あやねちゃん", group: "Team8", colors: ["水色", "赤"], source: "official2022" },
    { name: "徳永羚海", nickname: "れみたん", group: "Team8", colors: ["ピンク", "青"], source: "official2022" },
    { name: "永野芹佳", nickname: "せりちゃん", group: "Team8", colors: ["白", "白", "白"], source: "official2022" },
    ...
    { name: "橋本恵理子", nickname: "えりちゃん", group: "17期生", colors: ["赤", "黄"], source: "official2022" },
    { name: "畠山希美", nickname: "のんちゃん", group: "17期生", colors: ["紫", "青"], source: "official2022" },
    { name: "平田侑希", nickname: "ゆき", group: "17期生", colors: ["白", "紫"], source: "official2022" },
    { name: "布袋百椛", nickname: "ほてちゃん", group: "17期生", colors: ["ピンク", "赤"], source: "official2022" },
    { name: "正鋳真優", nickname: "まゆうちゃん", group: "17期生", colors: ["白", "白"], source: "official2022" },
    ...
    { name: "久保姫菜乃", nickname: "ちゃんひな", group: "18期生", colors: ["濃いピンク", "薄いピンク"], source: "fan" },
    { name: "迫由芽実", nickname: "ゆめみん", group: "18期生", colors: ["白", "水色"], source: "fan" },
    { name: "成田香姫奈", nickname: "こひ", group: "18期生", colors: ["紫", "黄"], source: "fan" },
    { name: "八木愛月", nickname: "あづ", group: "18期生", colors: ["ピンク", "黄"], source: "fan" },
    { name: "山口結愛", nickname: "ゆいち", group: "18期生", colors: ["赤", "オレンジ"], source: "fan" },

    // ---- 19期生 ----
    { name: "伊藤百花", nickname: "いともも", group: "19期生", colors: ["薄いピンク", "薄いピンク"], source: "fan" },
